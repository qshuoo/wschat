...
<body>
	<div class="container">
		...
		<div class="row clearfix" style="border-style: solid; border-color: gray">
			<!-- 左侧功能列表 -->
			<div id="fucli" class="col-md-4">
				...
				<div class="tabbable" id="tabs-503102">
					<ul class="nav nav-tabs">
						<li class="active">
							<a id="chat-sign" class="li-sign" href="#panel-121381" data-toggle="tab">会话</a>
						</li>
						<li>
							<a id="friend-sign" class="li-sign" href="#panel-121382" data-toggle="tab">好友</a>
						</li>
						<li>
							<a id="newfriend-sign" class="li-sign" href="#panel-121384" data-toggle="tab">新朋友</a>
						</li>
						<li>
							<a id="blist-sign" class="li-sign" href="#panel-121385" data-toggle="tab">黑名单</a>
						</li>
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane" id="panel-121384">
							<ul id="newfriend-list" class="list-group"></ul>
						</div>
						<div class="tab-pane" id="panel-121385">
							<ul id="blist-list" class="list-group"></ul>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-8 fuc-show" id="fuc-friend" style="background: #b0b0b0; height: 566px; padding-top: 50px; display: none;">
				...
				<div class="col-md-6" align="center" style="border: solid 2px gray; background: white; padding: 0px 0px 0px 0px;">
					<div style="background: #b3d4d4; height: 150px; padding-top: 50px">
						...
						<span class="input-group input-group-sm" style="width:200px;padding-top:10px;">
							<span class="input-group-addon">备注</span>
								<input id="friend-remark" type="text" class="form-control" value="">
							<span class="input-group-btn">
								<button id="btn-change-remark" class="btn btn-default" type="button">修改</button>
							</span>
						</span>
					</div>
			...
			<div class="col-md-8 fuc-show" id="fuc-newfriend" style="background: #b0b0b0; height: 566px; padding-top: 50px; display: none;">
				...
				<div class="col-md-6" align="center" style="border: solid 2px gray; background: white; padding: 0px 0px 0px 0px;">
					<div style="background: #b3d4d4; height: 150px; padding-top: 50px">
						<img id="newfriend-img" class="circle" src="/img/default.jpg"><br>
					</div>
					<div align="left" style="padding-top: 50px; padding-left: 100px">
			...
			<div class="col-md-8 fuc-show" id="fuc-chat" style="display: none;">
				...
				<form role="form">
					...
					<div id="snovo">
						...
						<div id="btn_send">
							<button id="send-msg" type="button" class="btn btn-default btn-sm " onclick="send()">发送</button>
						</div>
					</div>
				</form>
			</div>
		...
		<div class="modal fade" id="modal_user" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog" style="width: 500px;">
				<div class="modal-content">
					...
					<div id="modal-search-footer" class="modal-footer" align="center" style="text-align: center"></div>
				</div>
			</div>
		</div>

		<!-- 匿名聊天 -->
		<div class="modal fade" id="modal_secret" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog" style="width: 700px;">
				<div class="modal-content">
					<div id="modal-screct-header" class="modal-header" align=center>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div id="modal-screct-body" class="modal-body" align="center"></div>
					<div id="modal-screct-footer" class="modal-footer" align="center" style="text-align: center"></div>
				</div>
			</div>
		</div>
		
		<!-- 个人信息 -->
		<div class="modal fade" id="modal_pinfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog" style="width: 500px;">
				<div class="modal-content">
...
<!-- 									</div> -->
					...
					<div id="modal-pinfo-footer" class="modal-footer" align="center" style="text-align: center">
		...
		<div style="display: none">
			<form role="form">
				<div id="secert-convo" data-from="Sonu Joshi">
					<ul class="secert-chat-thread"></ul>
				</div>

				<div id="secert-snovo">
					<div class="form-group" style="margin-bottom: -10px;">
						<textarea id="secert-msg" class="form-control input_text_area" rows="4" style="resize: none; background-color: white; border: none; outline: medium;"></textarea>
					</div>
					<div id="btn_send">
						<button id="secert-send-msg" type="button" class="btn btn-default btn-sm ">发送</button>
					</div>
				</div>
			</form>
		</div>
